...
const MainContent = () => {
  return (
    <div className="MainContent">
      <div className='MainContent__card'><h1 className="MainContent__firstHeader">Base 0</h1>
      ...
      <div className='MainContent__card'><h1 className="MainContent__firstHeader">Base 55</h1>
